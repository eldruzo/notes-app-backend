...
class NotesService {
  ...
  editNoteById(id, { title, body, tags }) {
    ...
    if (noteIndex === -1) throw new NotFoundError('Gagal memperbaharui catatan, ID tidak ditemukan');
  ...
  deleteNoteById(id) {
    ...
    if (noteIndex === -1) throw new NotFoundError('Gagal menghapus catatan, ID tidak ditemukan');
